 ...
 * @beta
 */
export class MyViewSelector extends React.Component<
  ViewSelectorProps,
  ViewSelectorState
> {
  ...
  public static updateShowSettings(
    ...
    MyViewSelector._onViewSelectorShowUpdateEvent.emit({
      showSpatials,
      showDrawings,
      showSheets,
      showUnknown,
  ...
  public async componentDidMount() {
    ...
    if (this.props.listenForShowUpdates)
      this._removeShowUpdateListener = MyViewSelector._onViewSelectorShowUpdateEvent.addListener(
  ...
  private _setEnabled = async (item: ListItem, _enabled: boolean) => {
    ...
    // Emit a change event
    MyViewSelector.onViewSelectorChangedEvent.emit({
